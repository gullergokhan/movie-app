...
export async function getMoviesByTitle(movieTitle) {
  try {
    const res = await fetch(`https://api.themoviedb.org/3/search/movie?api_key=e0c53d47e2cd5e269c10981f65bb4d6f&query=${movieTitle}&language=pt-BR`);
    if (!res.ok) {
    ...
    throw new Error('Error happened while fetching movies by title', error);
  }
}
...
export async function getMovieReviews(movieId) {
  try {
    const res = await fetch(`https://api.themoviedb.org/3/movie/${movieId}/reviews?api_key=e0c53d47e2cd5e269c10981f65bb4d6f`);
    if (!res.ok) {
      throw new Error('Network response was not ok.');
    }
    const data = await res.json();
    ...
    throw new Error('Error happened while fetching movie reviews', error);  
  }
}

export async function getMovieCasts(movieId) {
  try {
    const res = await fetch(`https://api.themoviedb.org/3/movie/${movieId}/credits?api_key=e0c53d47e2cd5e269c10981f65bb4d6f&language=en-US`);
    if (!res.ok) {
      throw new Error('Network response was not ok.');
    }
    const data = await res.json();
...
export async function getSingleMovie(movieId) {
  try {
    const res = await fetch(`https://api.themoviedb.org/3/movie/${movieId}?api_key=e0c53d47e2cd5e269c10981f65bb4d6f&language=en-US`);
    if (!res.ok) {
      throw new Error('Network response was not ok.');
    }
    const data = await res.json();
